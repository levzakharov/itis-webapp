        ...
        <div class="block" data-user-id="${user.id}">
            ...
            <div class="edit">
                ...
                <form>
                    ...
                    <div class="name">
                        <input disabled type="date" value="Дата рождения: <#if user.birthday??>${user.birthday?number_to_date}</#if>">
                    </div>
                    <div class="name">
                    ...
                    <#if user.userGroup??>
                        <div class="name">
                            <input disabled type="text" value="Группа: <#if user.userGroup??>${user.userGroup.number}</#if>">
                        </div>
                        <div class="name">
